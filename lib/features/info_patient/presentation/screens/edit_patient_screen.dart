...
class _EditPatientScreenState extends State<EditPatientScreen> {
  ...
  final TextEditingController _emailController =
      TextEditingController(text: UserSingleton().email);
        ...
        listener: (context, state) {
          if (state.message == 'edit') {
            CustomShowDialog.showDialogAwesome(
                context,
                DialogType.success,
                'Sửa hồ sơ bệnh nhân thành công!',
          ...
          child: CustomElevatedButton(
            onPressed: () {
              if (_nameController.text != '' &&
                  ...
                  _sexController.text != '') {
                context.read<InfoPatientBloc>().add(EditInfoPatientEvent());
              } else {
                CustomToast.showToast(
                    context, 'Không được bỏ trống những trường bắt buộc');
              }
            },
            textBtn: 'Sửa hồ sơ bệnh nhân',
          ),
        ),
      ),
